...
### About the Developer
Prudhvi Vuppalapati is a Full Stack Developer with over 3 years of experience building scalable, cloud-native web applications using Java, Spring Boot, and Microservices. With a strong focus on backend optimization and data integrity, he specializes in designing high-performance enterprise solutions. This project serves as a demonstration of advanced SQL modeling and automated data auditing workflows.